 ...
 * @author phili
 */
public abstract class AbstractNoConnectFigure extends AbstractBean
        implements Figure {
    ...
    public AbstractNoConnectFigure() {
    }
 ...
 */
    ...
    @Override
    public AbstractNoConnectFigure clone() {
        AbstractNoConnectFigure that = (AbstractNoConnectFigure) super.clone();
